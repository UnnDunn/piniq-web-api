...
public class OpdbClient : IOpdbClient
{
    ...
    public Task<IEnumerable<Machine>> SearchAsync(string query, bool requireOpdb = true, bool includeGroups = false,
        bool includeAliases = true)
    {
        throw new NotImplementedException();
    }

    public Task<IEnumerable<Machine>> TypeaheadSearchAsync(string query, bool includeGroups = false,
        bool includeAliases = true)
    {
        throw new NotImplementedException();
    }

    private async Task<OpdbResponse> ExecuteRequest<T>(string uriString,
        Dictionary<string, string>? queryOptions = null)
    {
