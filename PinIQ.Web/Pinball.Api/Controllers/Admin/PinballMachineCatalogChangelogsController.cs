...
namespace Pinball.Api.Controllers.Admin
{
    ...
    public class PinballMachineCatalogChangelogsController : ControllerBase
    {
        ...
        public PinballMachineCatalogChangelogsController(IPinballMachineCatalogService catalogService, ILogger<PinballMachineCatalogChangelogsController> logger)
        {
            _logger = logger;
